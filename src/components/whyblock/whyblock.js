      ...
      <Container>
        <CardGroup className="mt-sm-3">
          <Card className="overflow ml-sm-2">
            ...
            <Card.Body>
              <Card.Title className="float-left">BlockChain</Card.Title>
              <br />
              <br />
              <Card.Text>
                {" "}
                Blockchain technology enables distributed public ledgers that
                hold immutable data in a secure and encrypted way and ensure
                that transactions can never be altered.{" "}
                <a href="https://www.investopedia.com/terms/b/blockchain.asp#what-is-blockchain">
                  continue...{" "}
                </a>
              </Card.Text>
            </Card.Body>
          ...
          <Card className=" overflow ml-sm-2">
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                Blockchain, as its name suggests, consists of multiple blocks
                strung together. In order for{" "}
                <a href="https://www.investopedia.com/terms/b/blockchain.asp#how-blockchain-works">
                  {" "}
                  continue...
                </a>
              </Card.Text>
          ...
          <Card className="overflow ml-sm-2">
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                linearly and chronologically.That is, they are al{" "}
                <a href="https://www.investopedia.com/terms/b/blockchain.asp#is-blockchain-secure">
                  continue...
                </a>
              </Card.Text>
            </Card.Body>
